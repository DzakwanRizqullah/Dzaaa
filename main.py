...
#                      (FINAL: FONT SIZE 180, KOORDINAT Y DISESUAIKAN, PATH ABSOLUT DIPERTAHANKAN)                   #
#====================================================================================================================#
...
# Folder output utama (PATH LOKAL DIJAGA)
...
for item in data:
    ...
    if "Kecepatan Angin" in kolom:
        ...
        try:
            ...
            # Y disesuaikan untuk font yang lebih besar (y + 25)
...
def send_email_with_attachments(image_path, csv_path):
    ...
    # --- MELAMPIRKAN FILE ---
    # 1. Melampirkan Gambar PNG
    attach_file_to_email(msg, image_path, file_type='image')

    # 2. Melampirkan Data CSV/Spreadsheet
